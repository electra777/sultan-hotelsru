	...
	return (
		<div className={styles.productCard}>
			<div className={styles.imgWrapper}>
				<img src={aos} alt="" className={styles.img} />
			</div>
			<div className={styles.iconWrapper}>
				...
				<div className={styles.size}>
					450
					<span className={styles.sizeValue}>мл</span>
				</div>
			</div>
			<div className={styles.title}>AOS средство для мытья посуды Crystal</div>
			...
			<div className={styles.manufacturer}>
				Производитель:
				<span className={styles.value}>Нэфис</span>
			</div>
			<div className={styles.brand}>
				Бренд:
				<span className={styles.value}>AOS</span>
			</div>
